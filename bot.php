...
'
				...
				$messages = [
					'type'=>'text',
					'text' =>'สิ่งที่น้องกำลังรู้สึกตอนนี้มันแสดงถึงว่าน้องเข้าใจความรู้สึกของตัวเองได้ดีทีเดียว คำตอบก็คือน้องต้องให้ความสนใจคนอื่นก่อนครับ สำหรับวัยของน้องเรื่องเพื่อนคงเป็นเรื่องใหญ่ ถ้าน้องอยากให้ใครดีกับน้อง น้องก็แสดงความเป็นมิตรกับเขาก่อนดูนะครับ ^^'
				];
			}else if((eregi ( "ทะเลาะกับแฟน", $text, $regs ))or(eregi ( "ผิดกับแฟน", $text, $regs ))){
				$messages = [
					'type'=>'text',
					'text' =>'อยากให้น้องคิดว่าการพูดขอโทษก่อนไม่ได้เป็นเรื่องน่าอับอายหรือเสียศักดิ์ศรีแต่ประการใด ไม่ว่าเรื่องที่เกิดขึ้นใครจะผิดมากกว่าใครแต่การที่สามารถเอ่ยปากขอโทษได้ก่อนมันแสดงให้เห็นว่าน้องลดทิฐิของตัวเองได้แล้วนะครับ'
				];
			}

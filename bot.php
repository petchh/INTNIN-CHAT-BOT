...
'
			...
			}else if((eregi ( "ชำระค่าเทอมช้า", $text, $regs ))or(eregi ( "จ่ายค่าเทอมล่าช้า", $text, $regs ))){
				$messages = [
					'type'=>'text',
					'text' =>''
				];
				...
				$messages = [
					'type'=>'text',
					'text' =>'ดาวน์โหลด มจท32 ที่เว็บ education.mju.ac.th แล้วยื่นที่งานตารางสอนครับ'
				];
			}else if((eregi ( "ขาดความอบอุ่น", $text, $regs ))or(eregi ( "ต้องการคนสนใจ", $text, $regs ))){
				$messages = [
					'type'=>'text',
					'text' =>'เป็นคำถามที่ดีนะครับเพราะมันแสดงถึงว่าน้องเข้าใจความรู้สึกของตัวเองได้ดีทีเดียว คำตอบง่ายๆ ก็คือน้องต้องให้ความสนใจคนอื่นก่อนครับ สำหรับวัยของน้องเรื่องเพื่อนคงเป็นเรื่องใหญ่ ถ้าน้องอยากให้ใครดีกับน้อง น้องก็แสดงความเป็นมิตรกับเขาก่อน ใช้ได้กับทั้งเพื่อนชาย เพื่อนหญิงนะครับ ที่สำคัญลองเริ่มทำแบบนี้กับคุณพ่อคุณแม่ผู้ปกครองดูสิครับ ผลที่ตอบกลับมาน้องอาจไม่ใช่เด็กขาดความอบอุ่นอีกเลยก็ได้ ^^'
				];
			}
